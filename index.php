...
echo "<script type='text/javascript'> document.location = 'myprofile.php'; </script>";
  ...
  echo "<script>alert('Opps! calm down and rem your deatils.');</script>";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="green darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">Afrinet  | Employee Leave Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="#">Anthony njiru </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4> Employee Leave Management System</h4></div>
