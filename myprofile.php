...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,Email=:email,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>EMP | Update Employee</title>
